...
?>
  ...
  <h3><a href="hello"><?=number_format(checkLatest($array_all, "US_infected")["amount"])?></a></h3>

  <h2>Deaths</h2>
  <h3><?=number_format(checkLatest($array_all, "US_death")["amount"])?></h3>

  <h2>Recovered</h2>
  <h3><?=number_format(checkLatest($array_all, "US_recovered")["amount"])?></h3>
  </div>
  ...
  <h2>Coronavirus Cases</h2>
  <h3><?=number_format(checkLatest($array_all, "OR_infected")["amount"])?></h3>

  <h2>Deaths</h2>
  <h3><?=number_format(checkLatest($array_all, "OR_death")["amount"])?></h3>
  </div>
  <br>
  <br>
  ...
  <h2>Coronavirus Cases</h2>
  <h3><?=number_format(checkLatest($array_all, "PA_infected")["amount"])?></h3>

  <h2>Deaths</h2>
  <h3><?=number_format(checkLatest($array_all, "PA_death")["amount"])?></h3>
  </div>
  <br>
  <br>
